...
# --- V12.1: TELEGRAM NATIVE API FUNCTIONS ---
    ...
    while True:
        ...
        if action_type == "done":
            ...
            if q_type == "yesno":
                ...
                # BUGFIX V12.1: Syntax Error Fixed Here!
...
def handle_commands(cmd_str, session):
    ...
    if cmd == "/help":
        table = Table(title="🌟 Daftar Perintah Pica AI V12.1", style=COLOR_PRIMARY)
        cmds = [
...
def show_logo():
   ...
   ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═╝
    ...
    console.print(Panel(Align.center(f"✨ [bold yellow]Pica AI V12.1 | Syntax Patch[/bold yellow] ✨\n"
                                     f"Ketik [bold cyan]/telegram <token> <id>[/bold cyan] untuk konek ke Bot.\n"
